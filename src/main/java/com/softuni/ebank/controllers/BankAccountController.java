...
public class BankAccountController {
    ...
    @PreAuthorize("isAuthenticated()")
    public String depositConfirm(@PathVariable("id") Long id, Model model, @ModelAttribute("bankAccountBindingModel") BankAccountBindingModel bankAccountBindingModel) {
    ...
    @PreAuthorize("isAuthenticated()")
    public String withdrawConfirm(@PathVariable("id") Long id, Model model, @ModelAttribute("bankAccountBindingModel") BankAccountBindingModel bankAccountBindingModel) {
    ...
    @PreAuthorize("isAuthenticated()")
    public String transferConfirm(@PathVariable("id") Long id, Model model, @ModelAttribute("bankAccountBindingModel") BankAccountBindingModel bankAccountBindingModel) {
